...
s_k_0_2[int_N] = sum_k_0_2/N;
error_s_k_0_2[int_N] = error_k_0_2;
s_k_2_2[int_N] = sum_k_2_2 / N;
error_s_k_2_2[int_N] = error_k_2_2;
s_k_0_4[int_N] = sum_k_0_4 / N;
error_s_k_0_4[int_N] = error_k_0_4;
s_k_2_4[int_N] = sum_k_2_4 / N;
error_s_k_2_4[int_N] = error_k_2_4;

c_2_4[int_N] = sum_k_2_4 / sum_k_0_4 - 2.0*(sum_k_2_2 / sum_k_0_2)*(sum_k_2_2 / sum_k_0_2);
c_2_2[int_N] = c_2_4_2;
error_c_2_2[int_N] = error_2;
s_2_4[int_N] = c_2_4_4;
error_s_2_4[int_N] = error_4;
error_c_2_4[int_N] = sqrt(error_4*error_4 + 4.0*2.0*error_2*error_2*c_2_4_2*c_2_4_2);
